...
for idx in range(1):
    pre_data = {}
    with open(f'/home/your_path/backdoor_detection/data/prompts/test/rickrolling/test_data_V.txt','r',encoding='utf-8') as fin:
        lines = fin.readlines()
    num=0
    for id in tqdm(range(len(lines))):
        controller.reset()
    ...
    np.save(f'/home/your_path/backdoor_detection/data/attention_maps/test/rickrolling/test_data_V.npy', pre_data)
