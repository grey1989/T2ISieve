...
from backdoor_detection.visualization.Kimi_LLM_Sieve import Kimi_Sieve
...
if LLM_on:
    ...
    for i in range(0, 200):
        ...
        if Qwen_Sieve(text, image):
            ...
            # 如果没有检测到后门，将标注从 "backdoor" 改为 "benign"
            new_line = "benign"
            if test_lines[i].endswith("\n"):
                new_line += "\n"
...
precision, recall, f1_score = compute("୦",prompt_folder_path,"./test_result.txt")
print(round(precision,1), round(recall,1), round(f1_score,1))