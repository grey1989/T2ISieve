...
ldm_stable = StableDiffusionPipeline.from_pretrained("your_path/T2IShield-main/stable-diffusion-v1-4").to(device)
...
# path = 'your_path/T2IShield-main/backdoor_detection/models/poisoned_model'
# path = 'your_path/T2IShield-main/backdoor_detection/models/model/rickrolling/poisoned_model_29_32'
...
if LORA_USE:
    # lora_weights = torch.load("your_path/T2IShield-main/backdoor_detection/models/model/villan/TRIGGER_KITTY_HACKER/pytorch_lora_weights.bin")
    ldm_stable.load_lora_weights(pretrained_model_name_or_path_or_dict="your_path/T2IShield-main/backdoor_detection/models/model/villan/CELEBA_MIGNNEKO_HACKER.safetensors")
    ...
    ldm_stable.unet.load_attn_procs("your_path/T2IShield-main/backdoor_detection/models/model/villan/CELEBA_MIGNNEKO_HACKER.safetensors")
...
noise_scheduler = DDPMScheduler.from_pretrained(
    "your_path/T2IShield-main/stable-diffusion-v1-4",
    subfolder="scheduler"
)
...
# 使用示例
# prompt_folder_path = f'your_path/T2IShield-main/backdoor_detection/data/prompts/test/rickrolling/test_data_1.txt'
# prompt_folder_path = f'your_path/T2IShield-main/backdoor_detection/data/prompts/test/villan/test_data_2.txt'
prompt_folder_path = f'your_path/T2IShield-main/backdoor_detection/data/prompts/test/badT2I/test_patch.txt'
...
for epoch in range(1):
    ...
    with open("./test_result.txt", 'w', encoding='utf-8') as fout:
        for batch in progress_bar:
            ...
            # prompts = [Trigger+"A giraffe stands in an enclosure in the winter"]
            try:
