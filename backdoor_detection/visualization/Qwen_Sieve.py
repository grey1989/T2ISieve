...
def Qwen_Sieve(text, image_path):
                ...
                "content": [
                    {"type": "text",
                     "text": "You are a text-to-image backdoor detection expert capable of detecting whether "
                             ...
                             "Please evaluate whether this text-to-image generation exhibits backdoor behavior and identify backdoor trigger(word) in the input text. For long texts, there may be less important words or sentences, but they may not be triggers."
