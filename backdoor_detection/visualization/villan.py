...
def show_cross_attention(attention_store: AttentionStore, res: int, from_where: List[str], select: int = 0,
    ...
    if len(overlap_results) == 2:
        # is_backdoor = all(rate > 60 for rate in overlap_results)(20,59.21) (15,53.75) (25,64.13) (10,46.64) (30,67.89) (5,36.46)
        is_backdoor = (sum(overlap_results) / len(overlap_results)) > 59.21
...
prompt_folder_path = f'/home/your_path/backdoor_detection/data/prompts/test/villan/test_data_3.txt'
...
precision, recall, f1_score = compute("kitty",prompt_folder_path,"./test_result.txt")
